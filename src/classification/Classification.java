...
public class Classification {
	...
	public String predict(String simple,boolean isIn,String ensemble,String base, int times)  throws Exception{
		String predict_result = "";
		BasicClassification use_classification = new SimpleClassification(data);
		...
		predict_result += "," + use_classification.classify(times, classifier, base);
		return predict_result;
