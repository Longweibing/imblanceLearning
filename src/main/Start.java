...
public class Start {
	...
	public static String runClassification(String project,String simple,boolean isIn,String ensemble,String base) throws IOException{
		String projects[] = {"weather"};
		Util util = new Util();
		String measure_name = "project, method, classifier, accuracy, recall-0, recall-1, precision-0, precision-1, fMeasure-0, fMeasure-1, gmean, auc \n";
//		util.saveResult(measure_name, output_file);
		...
		Classification classification = new Classification(data);
		try {
			predict_result = classification.predict(simple, isIn, ensemble,base, 1);
		} catch (Exception e) {
